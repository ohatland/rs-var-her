  ...
  return (
    <div className="map-container">
      <div className="map-selector">
        <select className="select-option" value={mapLayer} onChange={(e) => setMapLayer(e.target.value)}>
      ...
      <div className="ship-selector">
        <select className="select-option" value={ship.nr} onChange={(e) => handleShipSelect(e.target.value)}>
          {allShips.map((ship) => {
            return (
              <option value={ship.nr} key={ship.nr}>
