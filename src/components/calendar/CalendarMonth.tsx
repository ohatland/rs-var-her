export default function CalendarMonth({ today, year, month, selectedDate, handleDateClick }: { today: Date, year: number, month: number, selectedDate: Date, handleDateClick: (date: Date) => void }) {
    ...
    <div className="calendar">
      ...
      <div className="days">
        {daysBeforeTheMonthStart.map(i => {
          return <div key={i} className='disabled' style={{ color: 'white' }}>0</div>
        })}
        {days.map(date => {
